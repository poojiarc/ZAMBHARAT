...
export default function HomePage() {
  ...
  return (
    <div>
      <Helmet>
        <title>Zambharat Drill tech Limited | Water King — Borehole Drilling Zambia</title>
        ...
        <meta property="og:title" content="Zambharat Drill tech Limited — Water King" />
      ...
      <section className="container mx-auto px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
        <div className="reveal">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-4">
            Zambharat Drill tech Limited — known as <strong className="text-primary">ZAMBHARAT</strong> — is a leading Zambian drilling company delivering professional borehole drilling, geophysical surveys, pump installation and overhead tank construction.
          </p>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="text-center max-w-2xl mx-auto mb-12 reveal">
          ...
          <h2 className="text-3xl md:text-5xl font-black mt-2 mb-4 text-foreground">The ZAMBHARAT Difference</h2>
        </div>
